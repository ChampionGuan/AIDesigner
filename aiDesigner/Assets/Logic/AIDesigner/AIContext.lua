...
local AIContext = require("AIDesigner.Base.AIContext")

---@class AISystemContext:AIContext
local AISystemContext = AIUtil.Class("AISystemContext", AIContext)

function AISystemContext:ctor(master, view)
    AIContext.ctor(self, master, view)
...
function AISystemContext:GetDeltaTime()
    return CS.UnityEngine.Time.unscaledDeltaTime
end
